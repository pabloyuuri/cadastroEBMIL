...
require_once '../classes/CadastrosRecentesPessoasEstranhas.class.php';
require_once '../classes/Funcoes.class.php';
    $objCadastro = new CadastrosRecentesPessoasEstranhas();
    $objFcs = new Funcoes();
    $conexao = new Conexao();
...
<body>
    ...
    <?php
        require_once '../classes/Conexao.class.php';
        $conexao = new Conexao();
        $select = $conexao->conectar()->prepare("SELECT *FROM controlepessoas_table WHERE `data` = (SELECT CURRENT_DATE())"); 
        $select->execute();
    ?>
    <div id="lista">
                ...
                <table style="font-family: Arial;">
                    <form method="POST">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="nome" readonly="true" required="" value="<?=$objFcs->tratarCaracter((isset($id['nome']))?($id['nome']):(''), 1)?>"><br>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="number" name="rg" readonly="true" value="<?=$objFcs->tratarCaracter((isset($id['rg']))?($id['rg']):(''), 1)?>"><br>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="FalarCom"  value="<?=$objFcs->tratarCaracter((isset($id['FalarCom']))?($id['FalarCom']):(''), 2)?>"><br>
                            </td>
                        </tr>
                        <tr>
                            <th>
